...
our %config = (
  ...
  defines => [ "DSO_WIN32", "OPENSSL_THREADS", "OPENSSL_NO_STATIC_ENGINE", "OPENSSL_PIC" ],
  ...
  openssldir => "D:/notes/network/openssl/openssl-1.1.0l/win64-release/ssl",
  options => "enable-shared --debug --prefix=D:/notes/network/openssl/openssl-1.1.0l/win64-release --openssldir=D:/notes/network/openssl/openssl-1.1.0l/win64-release/ssl no-asan no-asm no-crypto-mdebug no-crypto-mdebug-backtrace no-ec_nistp_64_gcc_128 no-egd no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl => "D:\\Strawberry\\perl\\bin\\perl.exe",
  perlargv => [ "VC-WIN64A", "shared", "no-asm", "--debug", "--prefix=D:/notes/network/openssl/openssl-1.1.0l/win64-release", "--openssldir=D:/notes/network/openssl/openssl-1.1.0l/win64-release/ssl" ],
  prefix => "D:/notes/network/openssl/openssl-1.1.0l/win64-release",
  processor => "",
  ...
  target => "VC-WIN64A",
  version => "1.1.0l",
  version_num => "0x101000cfL",
);

our %target = (
  _conf_fname_int => [ "Configurations\\00-base-templates.conf", "Configurations\\00-base-templates.conf", "Configurations\\10-main.conf", "Configurations\\10-main.conf", "Configurations\\10-main.conf", "Configurations\\00-base-templates.conf", "Configurations\\00-base-templates.conf", "Configurations\\10-main.conf" ],
  ...
  cast_obj => "c_enc.o",
  cc => "cl",
  cflags => "-W3 -wd4090 -Gs0 -GF -Gy -nologo -DOPENSSL_SYS_WIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -D_CRT_SECURE_NO_DEPRECATE -DUNICODE -D_UNICODE /MDd /Od -DDEBUG -D_DEBUG",
